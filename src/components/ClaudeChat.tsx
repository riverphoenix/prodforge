...
export default function ClaudeChat({ projectId, visible = true }: ClaudeChatProps) {
  ...
  // Launched state: use absolute positioning so xterm.js gets real pixel dimensions
  return (
    <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column' }} className="bg-codex-bg">
